...
public class LibrarySourcesConfig extends Config {
    ...
    private void loadModuleDescriptor(LibraryUtils.Metadata metadata) {
        ...
        for(String packageName : metadata.getPackages()) {
            ...
            KotlinJavascriptPackageFragment packageFragment = new KotlinJavascriptPackageFragment(fqName, new LockBasedStorageManager(), moduleDescriptor, load);
            providers.add(packageFragment.getProvider());
        }
