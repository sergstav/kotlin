...
public class IdeErrorMessages {
    ...
    static {
        ...
        MAP.put(ErrorsJs.JSCODE_ERROR, "<html>JavaScript: {1}</html>", Renderers.TO_STRING, Renderers.TO_STRING, Renderers.TO_STRING);
        MAP.put(ErrorsJs.JSCODE_WARNING, "<html>JavaScript: {1}</html>", Renderers.TO_STRING, Renderers.TO_STRING, Renderers.TO_STRING);
        MAP.setImmutable();
    }
