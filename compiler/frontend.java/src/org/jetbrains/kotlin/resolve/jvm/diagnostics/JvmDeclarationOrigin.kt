...
public fun OtherOrigin(descriptor: DeclarationDescriptor): JvmDeclarationOrigin =
        OtherOrigin(DescriptorToSourceUtils.descriptorToDeclaration(descriptor), descriptor)
